...
<template v-slot:body>
  ...
  <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded">
    <v-table :fields="fields" :resources="resources" :actions="actions" :resource-name="resourceName" @order="orderByField">
    </v-table>

    <component :is="paginationComponent" v-if="resources.length > 0" @page="selectPage" :pages="totalPages" :page="currentPage" :per-page="currentPerPage" @per-page="updatePerPageChanged" :per-page-options="perPageOptions">
